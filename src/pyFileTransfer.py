...
def init():
    ...
    parser.add_argument('-poll', default=2, type=int, help='The polling time in seconds')
...
if __name__ == '__main__':
    arguments = init()
    file_handler = FileTransferHandler(arguments.destination, arguments.username, arguments.password)
    watch_source(arguments.source, file_handler, arguments.poll)
